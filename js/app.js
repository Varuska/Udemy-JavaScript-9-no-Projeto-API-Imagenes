...
function buscarImagenes(termino) {
    ...
    const key = '32611829-8f9d714596bd682400f2ca81b';
...
//Generador que va aregistrar la cantidad de elementos de las paginas
...
function mostrarImagenes(imagenes) {
    ...
    imagenes.forEach(imagen => {
        const { previewURL, likes, views, largeImageURL
        } = imagen;
